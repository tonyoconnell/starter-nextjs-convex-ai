...
core_principles:
  ...
  - KDD Pattern Validation: Validate implementation against established patterns in docs/patterns/ and existing examples in docs/examples/
  - Pattern Emergence Detection: Identify and flag novel approaches that could become documented patterns
