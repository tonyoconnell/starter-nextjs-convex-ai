...
Before creating ANY new files, Gemini MUST follow this discovery protocol:
...
## Gemini Navigation & Directory Awareness

**CRITICAL**: Gemini must maintain directory context awareness to prevent navigation errors.
