...
describe('MockEmailViewer', () => {
  ...
  it('expands when clicked', async () => {
    ...
    expect(screen.getByRole('heading', { name: /mock emails/i })).toBeInTheDocument()
  ...
  it('shows expired token indicator', async () => {
    ...
    ;(mockEmailService.getAllEmails as jest.Mock).mockReturnValue([expiredEmail])
  ...
  it('collapses when close button is clicked', async () => {
    ...
    expect(screen.getByRole('button', { name: /mock emails/i })).toBeInTheDocument()
    expect(screen.queryByRole('heading', { name: /mock emails/i })).not.toBeInTheDocument()
  })
  ...
  it('handles empty email list', async () => {
    ...
    const toggleButton = screen.getByRole('button', { name: /mock emails \(0\)/i })
    await user.click(toggleButton)
