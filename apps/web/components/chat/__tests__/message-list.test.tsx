...
describe('MessageList', () => {
  ...
  it('displays suggested questions in empty state', () => {
    ...
    expect(screen.getByText(/How does the admin monitoring system work/)).toBeInTheDocument();
    expect(screen.getByText(/What UI components are available/)).toBeInTheDocument();
    expect(screen.getByText(/Explain the Convex backend architecture/)).toBeInTheDocument();
  });
});